...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_LineEditHistory_t, stringdata) + ofs \
...
const QMetaObject LineEditHistory::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_LineEditHistory.data,
      qt_meta_data_LineEditHistory,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LineEditHistory.stringdata))
