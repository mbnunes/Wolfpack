...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_cUOSocket_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 32, 26)
    },
    "cUOSocket\0disconnected\0\0receive\0"
    "disconnectedImplementation\0"
};
...
const QMetaObject cUOSocket::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_cUOSocket.data,
      qt_meta_data_cUOSocket,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_cUOSocket.stringdata))
