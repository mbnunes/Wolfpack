...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PyProfiler_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 26, 4)
    ...
    "PyProfiler\0stopped\0\0start\0stop\0"
};
...
const QMetaObject PyProfiler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PyProfiler.data,
      qt_meta_data_PyProfiler,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PyProfiler.stringdata))
